...
class TaxiEnv(discrete.DiscreteEnv):
    ...
    Rewards: 
    There is a reward of -1 for each action and an additional reward of +20 for delivering the passenger. There is a reward of -10 for executing actions "pickup", "dropoff", "fill" illegally.
